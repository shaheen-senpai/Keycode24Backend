...
import Group from '../../../core/authorization/entity/group.entity';
import { GroupService } from '../../../core/authorization/service/group.service';
...
export class GroupResolver {
  ...
  getCustomerGroups(): Promise<Group[]> {
    return this.groupService.getCustomerGroups();
  }
