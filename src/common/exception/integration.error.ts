...
export enum ErrorCode {
  ...
  CB_014 = 'CB_014', // on get all invoices
  CB_015 = 'CB_015', // on get hosted page for due payments
  CB_016 = 'CB_016', // on get invoice download url
  CB_017 = 'CB_017', // on reactivate subscription
  ...
  OS_013 = 'OS_013', // on put roles (update package)
  ...
  ML_004 = 'ML_004', // on generating clause recommendations
  ML_005 = 'ML_005', // on getting clause labels
  ML_006 = 'ML_006', // on geting multiple resource requests
  ...
  //SIREN
  SR_001 = 'SR_001', // on siren error

  //IP API
  IP_001 = 'IP_001', // on ip api error
}
...
export function throwIntegrationError(
  ...
  } else if (isObject(error) && (error as Error).message) {
